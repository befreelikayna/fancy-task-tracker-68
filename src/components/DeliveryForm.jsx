    ...
    <div className="flex flex-col gap-2 mb-4 sm:mb-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
        <input
          ...
          className="w-full p-2 sm:p-3 border-2 border-white rounded-lg focus:outline-none focus:border-purple-500 bg-white bg-opacity-50 text-white placeholder-white text-sm sm:text-base"
        />
        <input
          type="text"
          placeholder="Shot"
        ...
        <input
          ...
          onChange={handleInputChange}
          className="w-full p-2 sm:p-3 border-2 border-white rounded-lg focus:outline-none focus:border-purple-500 bg-white bg-opacity-50 text-white text-sm sm:text-base"
        />
      </div>
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <label className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-teal-500 text-white p-2 sm:p-3 rounded-lg hover:from-blue-600 hover:to-teal-600 transition duration-300 text-sm sm:text-base cursor-pointer text-center">
          <input
            type="file"
            accept=".xlsx, .xls"
